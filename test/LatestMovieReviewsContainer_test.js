...
describe('<LatestMovieReviewsContainer />', () => {
  ...
  it('should fetch data from the New York Times API', () => {
    ...
    expect(fetchSpy.firstCall.lastArg, "Fetch should have the base URL '//api.nytimes.com/svc/movies/v2/reviews/all/json?'").to.include('//api.nytimes.com/svc/movies/v2/reviews/all/json?')
  })
